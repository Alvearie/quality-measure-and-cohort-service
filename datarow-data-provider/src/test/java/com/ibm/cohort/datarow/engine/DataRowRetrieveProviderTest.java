...
public class DataRowRetrieveProviderTest {
	...
	public void testRetrieveNoCodeFilterHasDataKnownDataType() {
		...
		Iterable<Object> rows = retrieveProvider.retrieve(CONTEXT_CLAIM, FIELD_PERSON_ID, null, DATATYPE_PERSON, null, null, null, null, null, null, null, null);
	...
	public void testRetrieveNoCodeFilterUnknownDataType() {
		...
		Iterable<Object> rows = retrieveProvider.retrieve(CONTEXT_CLAIM, FIELD_PERSON_ID, null, "unknown", null, null, null, null, null, null, null, null);
	...
	public void testRetrieveFilterByProvidedCodes() {
		...
		List<Code> codes = Arrays.asList(GENDER_MALE).stream().map(g -> new Code().withCode(g)).collect(Collectors.toList());
	...
	public void testRetrieveFilterByProvidedCodesNoMatch() {
		...
		List<Code> codes = Arrays.asList("unknown").stream().map(g -> new Code().withCode(g)).collect(Collectors.toList());
	...
	public void testRetrieveFilterByProvidedCodesUnknownDataType() {
		...
		Iterable<Object> rows = retrieveProvider.retrieve(CONTEXT_CLAIM, FIELD_PERSON_ID, null, "unknown", null, FIELD_GENDER, codes, null, null, null, null, null);
		assertEquals(0, count(rows));
	}
	...
	public void testRetrieveFilterByValueSet() {
		...
		Iterable<Object> rows = retrieveProvider.retrieve(CONTEXT_CLAIM, FIELD_PERSON_ID, null, DATATYPE_PERSON, null, FIELD_GENDER, null, valueSetId, null, null, null, null);
	...
	public void testRetrieveFilterByValueSetUnknown() {
		...
		assertThrows( IllegalArgumentException.class, () -> retrieveProvider.retrieve(CONTEXT_CLAIM, FIELD_PERSON_ID, null, DATATYPE_PERSON, null, FIELD_GENDER, null, valueSetId, null, null, null, null));
	}
