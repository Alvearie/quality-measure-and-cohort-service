...
public class CohortEngineRestHandler {
	...
	public static final String EXAMPLE_REQUEST_DATA_JSON = "<p>A configuration file containing the information needed to process a measure evaluation request. Two possible FHIR server endoints can be configured <code>dataServerConfig</code> and <code>terminologyServerConfig</code>. Only the <code>dataServerConfig</code> is required. If <code>terminologyServerConfig</code> is not provided, the connection details are assumed to be the same as the <code>dataServerConfig</code> connection.</p>" +
			...
			"<p>For more detailed information about the cohort endpoint, check out our <a href=\"http://alvearie.io/quality-measure-and-cohort-service/#/user-guide/rest_endpoints?id=measure-endpoint\">documentation</a> here.</p>" +
			"<p>Example Contents: \n <pre>{\n" +
			"    \"dataServerConfig\": {\n" + 
	...
	public static final String EXAMPLE_COHORT_REQUEST_DATA_JSON = "<p>A configuration file containing the information needed to process a cohort evaluation request. Two possible FHIR server endoints can be configured <code>dataServerConfig</code> and <code>terminologyServerConfig</code>. Only the <code>dataServerConfig</code> is required. If <code>terminologyServerConfig</code> is not provided, the connection details are assumed to be the same as the <code>dataServerConfig</code> connection.</p>" +
			...
			"<p>For more detailed information about the cohort endpoint, check out our <a href=\"http://alvearie.io/quality-measure-and-cohort-service/#/user-guide/rest_endpoints?id=cohort-endpoint\">documentation</a> here.</p>" +
			"<p>Example Contents: \n <pre>{\n" +
			"    \"dataServerConfig\": {\n" +
			"        \"@class\": \"com.ibm.cohort.fhir.client.config.IBMFhirServerConfig\",\n" +
			"        \"endpoint\": \"ENDPOINT\",\n" +
