...
#ENABLE_DARK_FEATURES, LIBERTY_INITIAL_HEAP_SIZE, LIBERTY_MAX_HEAP_SIZE should be passed in by Helm, see values.yaml and deployment.yaml for references
replaceToken $JVM_OPTIONS_FILE ENABLE_DARK_FEATURES_TOKEN $ENABLE_DARK_FEATURES
replaceToken $JVM_OPTIONS_FILE LIBERTY_INITIAL_HEAP_SIZE_TOKEN $LIBERTY_INITIAL_HEAP_SIZE
replaceToken $JVM_OPTIONS_FILE LIBERTY_MAX_HEAP_SIZE_TOKEN $LIBERTY_MAX_HEAP_SIZE
