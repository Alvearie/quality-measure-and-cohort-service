...
public class MeasureEvaluationSeeder {
	...
	public IMeasureEvaluationSeed create(Measure measure, String periodStart, String periodEnd, String productLine) {
		...
		org.cqframework.cql.elm.execution.Library library = LibraryHelper.resolvePrimaryLibrary(measure, libraryLoader, this.libraryResourceProvider);
		...
		// todo: [daniel.kim] this only returns the last seen data provider
		// is this a bug?
	...
	private Context createContext(
			...
			String productLine) {
		// todo: [daniel.kim] make sure all context.set calls are accounted for
		...
		// todo: [daniel.kim] how is this different from the MeasurePeriod field?
	...
	private Interval createMeasurePeriod(String periodStart, String periodEnd) {
