...
class MeasureEvaluationAPITests(TestClass):
    ...
    def test_evaluateMeasureWithSNOMEDCodes(self):
        ...
        expectedResp = '{"resourceType":"MeasureReport","status":"complete","type":"individual","measure":"Measure/Over60AndHadColonscopyFromCode-1.1.1","subject":{"reference":"Patient/00ce7acb-5daa-3509-2e9f-211976bc70e1"},"period":{"start":"2019-03-18T00:00:00.000+00:00","end":"2020-09-18T23:59:59.999+00:00"},"group":[{"population":[{"code":{"coding":[{"system":"http://terminology.hl7.org/CodeSystem/measure-population","code":"initial-population"}]},"count":1},{"code":{"coding":[{"system":"http://terminology.hl7.org/CodeSystem/measure-population","code":"numerator"}]},"count":1},{"code":{"coding":[{"system":"http://terminology.hl7.org/CodeSystem/measure-population","code":"denominator"}]},"count":1}],"measureScore":{"value":1.0}}]}'
    ...
    def test_evaluateMeasureWithValueSets(self):
        ...
        print("status from response is : " + str(status))
        assert '200' in str(status), 'Should contain 200 and Measure report returned'
        expectedResp = '{"resourceType":"MeasureReport","status":"complete","type":"individual","measure":"Measure/Over60andHadColonoscopyFromVS-1.1.1","subject":{"reference":"Patient/00ce7acb-5daa-3509-2e9f-211976bc70e1"},"period":{"start":"2019-03-18T00:00:00.000+00:00","end":"2020-09-18T23:59:59.999+00:00"},"group":[{"population":[{"code":{"coding":[{"system":"http://terminology.hl7.org/CodeSystem/measure-population","code":"initial-population"}]},"count":1},{"code":{"coding":[{"system":"http://terminology.hl7.org/CodeSystem/measure-population","code":"numerator"}]},"count":1},{"code":{"coding":[{"system":"http://terminology.hl7.org/CodeSystem/measure-population","code":"denominator"}]},"count":1}],"measureScore":{"value":1.0}}]}'
        assert expectedResp in response, 'Response should contain ' + expectedResp
