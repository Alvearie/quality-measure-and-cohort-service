...
class ServiceStatus(object):
    ...
    def __init__(self, version=None, up_time=None, service_state=None, state_details=None, host_name=None, request_count=None, max_memory_mb=None, commited_memory_mb=None, in_use_memory_mb=None, available_processors=None, concurrent_requests=None, max_concurrent_requests=None, total_rejected_requests=None, total_blocked_requests=None):  # noqa: E501
