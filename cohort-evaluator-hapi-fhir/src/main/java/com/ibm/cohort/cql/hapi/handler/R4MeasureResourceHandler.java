...
/**
 * The R4 HAPI FHIR {@link Measure} implementation of {@link ResourceHandler}.
 */
public class R4MeasureResourceHandler implements ResourceHandler<Measure, Identifier> {
