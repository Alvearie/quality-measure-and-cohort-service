...
The available timeout configuraiton options are as follows:
...
Each timeout will be set to a default of 10 seconds if it is not specified in the configuration file.
