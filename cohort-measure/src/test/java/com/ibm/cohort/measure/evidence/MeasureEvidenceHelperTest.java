...
public class MeasureEvidenceHelperTest {
	...
	public void testMeasureEvidenceKey() {
		...
		libraryId1.setVersion(DEFAULT_VERSION);
		
		VersionedIdentifier libraryId2 = new VersionedIdentifier();
		libraryId2.setId(libraryName2);
		libraryId2.setVersion(DEFAULT_VERSION);
		
		String define1 = "define1";
		String define2 = "define2";
		
		assertEquals(libraryName1 + "_" + DEFAULT_VERSION + "." + define1, MeasureEvidenceHelper.createEvidenceKey(libraryId1, define1));
		assertEquals(libraryName1 + "_" + DEFAULT_VERSION + "." + define2, MeasureEvidenceHelper.createEvidenceKey(libraryId1, define2));
		assertEquals(libraryName2 + "_" + DEFAULT_VERSION + "." + define1, MeasureEvidenceHelper.createEvidenceKey(libraryId2, define1));
		assertEquals(libraryName2 + "_" + DEFAULT_VERSION + "." + define2, MeasureEvidenceHelper.createEvidenceKey(libraryId2, define2));
	}
}
