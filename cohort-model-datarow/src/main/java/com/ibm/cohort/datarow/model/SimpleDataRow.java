...
/**
 * Map-based implementation of DataRow. Contents of the map are expected to be
 * in whatever final form is required for the CQL Engine. For example, date and
 * datetime values should be in the CQL Runtime typesystem.
 */
